...
if ($stin) {
    if (isset($_REQUEST['saveonly'])) {
        ...
        $lnk = "indian_model_photoshoot_images_list.php";
        header("Location:" . $lnk . "");
...
$insert_query =" insert into blog (title, image_name, date_created, blog_description, author_name) values ('$title','$fileName',now(),'$blog_description', '$author_name');";
...
<form id="form" enctype="multipart/form-data" name="form" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" >
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1 >
                <span style="font-size: 15px;"><a href="blog_list.php"> Home </a> > <a href="blog_list.php">Blog Upload</a>  > Edit </span>
            </h1>

            <ol class="breadcrumb">
                <li> 
                    <button style="margin-left:20px;margin-right: 30px;margin-top:-10px;" class="btn btn-info btn-icon" name="Back" id="back" type="button" title="Back" onclick="location.href = 'blog_list.php'" ><i class="fa fa-reply"></i></button>  
                                ...
                                <div class="active tab-pane" id="pagedata">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class= "display-other-images">
                                            <img id="blah" <?php if($arr['image_name'] !=null){ ?> src="images/blog/<?php echo $arr['image_name']; ?>"<?php } ?>alt="" width="260px;" />
                                        </div>   
                                    </div>
                                    <br/>
                                    <div class="form-group clearfix">
